...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxLifecycleLibraryAccessors extends SubDependencyFactory {
        ...
        public AndroidxLifecycleLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getExtensions() { return create("androidx.lifecycle.extensions"); }
    ...
    public static class PlayServicesLibraryAccessors extends SubDependencyFactory {
        ...
        public PlayServicesLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for nearby (com.google.android.gms:play-services-nearby)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getNearby() { return create("play.services.nearby"); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Returns the group of versions at versions.joda
         */
        public JodaVersionAccessors getJoda() { return vaccForJodaVersionAccessors; }
         ...
         */
        public WorkVersionAccessors getWork() { return vaccForWorkVersionAccessors; }
    ...
    public static class ConverterVersionAccessors extends VersionFactory  {
        ...
        public ConverterVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: converter.moshi (2.9.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getMoshi() { return getVersion("converter.moshi"); }
    ...
    public static class FragmentVersionAccessors extends VersionFactory  {
        ...
        public FragmentVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: fragment.ktx (1.6.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class JodaVersionAccessors extends VersionFactory  {
        ...
        public JodaVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: joda.time (2.12.5)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getTime() { return getVersion("joda.time"); }

    }

    public static class KotlinVersionAccessors extends VersionFactory  {

        private final KotlinStdlibVersionAccessors vaccForKotlinStdlibVersionAccessors = new KotlinStdlibVersionAccessors(providers, config);
        public KotlinVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the group of versions at versions.kotlin.stdlib
         */
        public KotlinStdlibVersionAccessors getStdlib() { return vaccForKotlinStdlibVersionAccessors; }

    }

    public static class KotlinStdlibVersionAccessors extends VersionFactory  {

        public KotlinStdlibVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: kotlin.stdlib.jdk7 (1.8.20)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getJdk7() { return getVersion("kotlin.stdlib.jdk7"); }
    ...
    public static class KotlinxCoroutinesVersionAccessors extends VersionFactory  {
        ...
        public KotlinxCoroutinesVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: kotlinx.coroutines.android (1.6.4)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class MoshiVersionAccessors extends VersionFactory  {
        ...
        public MoshiVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: moshi.kotlin (1.14.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class NavigationVersionAccessors extends VersionFactory  {
         ...
         */
        public NavigationSafeVersionAccessors getSafe() { return vaccForNavigationSafeVersionAccessors; }
    ...
    public static class NavigationSafeVersionAccessors extends VersionFactory  {
         ...
         */
        public NavigationSafeArgsVersionAccessors getArgs() { return vaccForNavigationSafeArgsVersionAccessors; }
    ...
    public static class NavigationSafeArgsVersionAccessors extends VersionFactory  {
         ...
         */
        public NavigationSafeArgsGradleVersionAccessors getGradle() { return vaccForNavigationSafeArgsGradleVersionAccessors; }
    ...
    public static class PlayServicesVersionAccessors extends VersionFactory  {
        ...
        public PlayServicesVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: play.services.nearby (18.7.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getNearby() { return getVersion("play.services.nearby"); }
    ...
    public static class RoomVersionAccessors extends VersionFactory  {
        ...
        public RoomVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: room.ktx (2.5.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class WorkVersionAccessors extends VersionFactory  {
         ...
         */
        public WorkRuntimeVersionAccessors getRuntime() { return vaccForWorkRuntimeVersionAccessors; }
